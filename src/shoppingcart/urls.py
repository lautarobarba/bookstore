...
from shoppingcart.views import (
    CartDetailView, add_to_cart, remove_from_cart, add_to_cart_from_wishlist,
...
urlpatterns = [
    ...
    path('add-to-cart-from-wishlist/<int:pk>/', add_to_cart_from_wishlist, name='add-to-cart-from-wishlist'),
